...
const ExcalidrawWrapper = () => {
  ...
  // voxen: de-branded — removed the ExcalidrawPlusCommand /
  // ExcalidrawPlusAppCommand command-palette definitions (linked out to
  // Excalidraw+).
    ...
    >
      <Excalidraw
        ...
        UIOptions={{
          canvasActions: {
            toggleTheme: true,
            // voxen: de-branded — removed the "Export to Excalidraw+" card
            // (renderCustomUI) from the export dialog. The shareable-link
            // export (onExportToBackend) is left intact.
            export: {
              onExportToBackend,
            },
          },
        ...
        renderTopRightUI={(isMobile) => {
          ...
          const collabUI =
            collabAPI && !isCollabDisabled ? (
              <>
                {/* voxen: de-branded — removed the ExcalidrawPlusPromoBanner
                    (Excalidraw+ promo/redirect). */}
                {collabError.message && (
      ...
      >
        ...
        <OverwriteConfirmDialog>
          ...
          {/* voxen: de-branded — removed the "Export to Excalidraw+" action
              from the overwrite-confirm dialog. */}
        </OverwriteConfirmDialog>
        ...
        <CommandPalette
          customCommandPaletteItems={[
            ...
            /* voxen: de-branded — removed the GitHub, Follow us (X),
               Discord, YouTube, Excalidraw+, and Export-to-Excalidraw+
               command-palette entries (all linked out to excalidraw.com /
               Excalidraw+). */
            {
